...
def create_random_patches(img_basenames, annotation_dir, img_dir, size, step, max_imgs=0, grayscale=False, progressbar=True):
    ...
    for image_idx in range(len(img_basenames)):
        ...
        # get labels #
        curr_labels = get_patch_labels_for_single_image(img_basename,  annotation_dir, img_dir, size, step, width, height)
